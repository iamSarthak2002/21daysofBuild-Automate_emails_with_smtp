...
names_and_emails = [
  ['Asiqur', 'asiqur@machao.com'],
  ['Dharma', 'dharma@machao.com'],
  ['Jerry', 'jerry@machao.com'],
  ['Lillian', 'lillian@machao.com'],
  ['Malcolm', 'malcolm@machao.com'],
  ['Rose', 'rose@machao.com'],
  ['Sonny', 'sonny@machao.com'],
]
